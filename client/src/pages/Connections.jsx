...
const Connections = () => {
  ...
  const dataArray = [
    { label: "Followers", data: followers, icon: Users },
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-6xl mx-auto p-6">
        ...
        {/* Tabs */}
        <div className="inline-flex flex-wrap items-center border-gray-200 rounded-md p-1 bg-white shadow-sm border">
          {dataArray.map((tab) => (
            <button
        ...
        <div className="flex flex-wrap gap-6 mt-6">
          {dataArray
            ...
            ?.data.map((user) => (
              <div
                key={user._id}
                className="w-full max-w-88 flex gap-5 rounded-md p-6 bg-white shadow"
              >
                <img
